...
export type RecipeCategory = 'starter' | 'main' | 'quick' | 'bbq';
...
export interface RecipeIngredient {
  ...
  quantity: string;
  unit: string;
  /** If set, links to a Bellat product the user can add to cart */
  bellatProductId?: string;
}
...
export const RECIPES: Recipe[] = [
  {
    ...
    category: 'quick',
    ingredients: [
      { nameFr: 'Chawarma Épicée Bellat', nameAr: 'شاورما حارة بيلات', quantity: '400', unit: 'g', bellatProductId: 'prod_009' },
      { nameFr: 'Pain pita', nameAr: 'خبز البيتا', quantity: '4', unit: 'pièces' },
      { nameFr: 'Tomate', nameAr: 'طماطم', quantity: '2', unit: 'pièces' },
      { nameFr: 'Oignon', nameAr: 'بصل', quantity: '1', unit: 'pièce' },
      { nameFr: 'Persil frais', nameAr: 'بقدونس طازج', quantity: '1', unit: 'bouquet' },
      { nameFr: 'Yaourt nature', nameAr: 'لبن طبيعي', quantity: '200', unit: 'g' },
      { nameFr: 'Ail', nameAr: 'ثوم', quantity: '2', unit: 'gousses' },
      { nameFr: 'Jus de citron', nameAr: 'عصير ليمون', quantity: '1', unit: 'c. à soupe' },
    ],
    stepsFr: [
  ...
  },
  {
    ...
    category: 'quick',
    ingredients: [
      { nameFr: 'Kachir Bœuf Premium Bellat', nameAr: 'كشير بقري فاخر بيلات', quantity: '200', unit: 'g', bellatProductId: 'prod_001' },
      { nameFr: 'Pain de mie', nameAr: 'خبز التوست', quantity: '4', unit: 'tranches' },
      { nameFr: 'Fromage fondu (tranches)', nameAr: 'جبن مذاب (شرائح)', quantity: '4', unit: 'tranches' },
      { nameFr: 'Tomate', nameAr: 'طماطم', quantity: '1', unit: 'pièce' },
      { nameFr: 'Moutarde douce', nameAr: 'خردل حلو', quantity: '1', unit: 'c. à soupe' },
      { nameFr: 'Beurre', nameAr: 'زبدة', quantity: '20', unit: 'g' },
    ],
    stepsFr: [
  ...
  },
  {
    ...
    category: 'main',
    ingredients: [
      { nameFr: 'Mortadella Bellat', nameAr: 'مرتديلا بيلات', quantity: '150', unit: 'g', bellatProductId: 'prod_006' },
      { nameFr: 'Salami Premium Bellat', nameAr: 'سلامي فاخر بيلات', quantity: '100', unit: 'g', bellatProductId: 'prod_008' },
      { nameFr: 'Saucisses Hot Dog Bellat', nameAr: 'نقانق هوت دوج بيلات', quantity: '3', unit: 'pièces', bellatProductId: 'prod_004' },
      { nameFr: 'Pâte à pizza (ronde, 30 cm)', nameAr: 'عجينة بيتزا (دائرية، 30 سم)', quantity: '1', unit: 'pièce' },
      { nameFr: 'Concentré de tomates', nameAr: 'معجون الطماطم', quantity: '3', unit: 'c. à soupe' },
      { nameFr: 'Mozzarella râpée', nameAr: 'موزاريلا مبشورة', quantity: '200', unit: 'g' },
      { nameFr: 'Poivron rouge', nameAr: 'فلفل أحمر', quantity: '1', unit: 'pièce' },
      { nameFr: 'Champignons en boîte', nameAr: 'فطر معلب', quantity: '100', unit: 'g' },
      { nameFr: 'Origan séché', nameAr: 'زعتر مجفف', quantity: '1', unit: 'c. à café' },
    ],
    stepsFr: [
  ...
  },
  {
    ...
    category: 'starter',
    ingredients: [
      { nameFr: 'Luncheon Poulet Bellat', nameAr: 'لانشون دجاج بيلات', quantity: '200', unit: 'g', bellatProductId: 'prod_002' },
      { nameFr: 'Laitue', nameAr: 'خس', quantity: '1', unit: 'tête' },
      { nameFr: 'Tomates cerises', nameAr: 'طماطم كرزية', quantity: '100', unit: 'g' },
      { nameFr: 'Maïs en boîte', nameAr: 'ذرة معلبة', quantity: '80', unit: 'g' },
      { nameFr: 'Concombre', nameAr: 'خيار', quantity: '1', unit: 'pièce' },
      { nameFr: 'Olives noires', nameAr: 'زيتون أسود', quantity: '50', unit: 'g' },
      { nameFr: 'Huile d\'olive', nameAr: 'زيت زيتون', quantity: '3', unit: 'c. à soupe' },
      { nameFr: 'Vinaigre balsamique', nameAr: 'خل بلسمي', quantity: '1', unit: 'c. à soupe' },
      { nameFr: 'Moutarde', nameAr: 'خردل', quantity: '1', unit: 'c. à café' },
    ],
    stepsFr: [
  ...
  },
  {
    ...
    category: 'main',
    ingredients: [
      { nameFr: 'Rôti de Dinde Bellat', nameAr: 'روتي الديك الرومي بيلات', quantity: '1', unit: 'pièce (800 g)', bellatProductId: 'prod_003' },
      { nameFr: 'Carottes', nameAr: 'جزر', quantity: '2', unit: 'pièces' },
      { nameFr: 'Poivron vert', nameAr: 'فلفل أخضر', quantity: '1', unit: 'pièce' },
      { nameFr: 'Oignon', nameAr: 'بصل', quantity: '1', unit: 'pièce' },
      { nameFr: 'Ail', nameAr: 'ثوم', quantity: '3', unit: 'gousses' },
      { nameFr: 'Bouillon de volaille', nameAr: 'مرق دجاج', quantity: '200', unit: 'ml' },
      { nameFr: 'Huile d\'olive', nameAr: 'زيت زيتون', quantity: '4', unit: 'c. à soupe' },
      { nameFr: 'Thym, laurier', nameAr: 'زعتر وورق الغار', quantity: '1', unit: 'bouquet garni' },
      { nameFr: 'Pommes de terre', nameAr: 'بطاطس', quantity: '4', unit: 'pièces' },
    ],
    stepsFr: [
  ...
  },
  {
    ...
    category: 'starter',
    ingredients: [
      { nameFr: 'Pâté de Volaille Bellat', nameAr: 'باتي دجاج بيلات', quantity: '1', unit: 'boîte (200 g)', bellatProductId: 'prod_005' },
      { nameFr: 'Baguette', nameAr: 'خبز الباجيت', quantity: '1', unit: 'pièce' },
      { nameFr: 'Tomates cerises', nameAr: 'طماطم كرزية', quantity: '12', unit: 'pièces' },
      { nameFr: 'Basilic frais', nameAr: 'ريحان طازج', quantity: '1', unit: 'bouquet' },
      { nameFr: 'Ail', nameAr: 'ثوم', quantity: '1', unit: 'gousse' },
      { nameFr: 'Huile d\'olive', nameAr: 'زيت زيتون', quantity: '2', unit: 'c. à soupe' },
      { nameFr: 'Fleur de sel', nameAr: 'ملح خشن', quantity: '1', unit: 'pincée' },
    ],
    stepsFr: [
...
export const CATEGORY_LABELS: Record<RecipeCategory, { fr: string; ar: string }> = {
...
export const DIFFICULTY_LABELS: Record<RecipeDifficulty, { fr: string; ar: string }> = {
